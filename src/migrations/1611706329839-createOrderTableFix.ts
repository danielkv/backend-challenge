...
export class createOrderTableFix1611706329839 implements MigrationInterface {
    name = 'createOrderTableFix1611706329839'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `order_products` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `price` float NOT NULL, `quantity` int NOT NULL, `referenceProductId` int NULL, `orderId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
